...
public final class Logger {
    ...
    public static final String SCHEMA = "10";
    ...
    private static final String STATE_HDR =
          ...
          + "mock,reject,obd_speed,obd_link,flags,acc_std,moving,hdg,hdg_abs,motion_src,shown_kmh,obd_age_ms,nmea_ok,dr_src,dr_sig,gps_src,nmea_sats,nmea_age_ms";
